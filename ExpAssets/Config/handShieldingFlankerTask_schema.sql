...
data in the database to text files found in handShieldingFlankerTask/ExpAssets/Data.
...
CREATE TABLE trials (
    ...
    left_flanker_congruent text not null,
    right_flanker_congruent text not null,
